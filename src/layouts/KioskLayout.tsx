...
export const KioskLayout = () => {
  ...
  return (
    <div className="relative h-[100dvh] w-full flex flex-col overflow-hidden selection:bg-[#f03861]/20 bg-[#fafafc] text-gray-900 font-sans">
      ...
      <div className="fixed left-[max(1.5rem,env(safe-area-inset-left))] top-[max(1.5rem,env(safe-area-inset-top))] z-40 pointer-events-auto">
        <Button
          type="button"
          variant="outline"
          size="sm"
      ...
      <main className="flex-1 flex flex-col z-10 pb-28 pt-24">
        <Outlet />
      </main>

      <footer className="absolute bottom-0 left-0 w-full px-6 pb-6 pt-4 sm:px-8 sm:pb-8 flex justify-between items-end z-20 pointer-events-none">
        <div className="w-1/3"></div>

        <div className="w-1/3 flex justify-center">
          <div className="bg-white border border-gray-100 shadow-sm rounded-full px-6 py-2 flex items-center space-x-2">
