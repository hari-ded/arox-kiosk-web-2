...
export const PrintStatus = () => {
  ...
  return (
    <div className="kiosk-screen flex-1 flex flex-col items-center justify-center p-6 relative z-10">
      <Card className="kiosk-card w-full max-w-2xl p-16 text-center shadow-2xl border-0 overflow-hidden relative bg-white/95 backdrop-blur-xl rounded-[3rem]">
        {status === 'printing' && (
          <div className="space-y-10 flex flex-col items-center">
            <div className="kiosk-hero-icon kiosk-hero-icon--warm w-40 h-40 bg-[#fff7ed] rounded-full flex items-center justify-center relative">
            ...
            <div className="space-y-4 w-full">
              <h2 className="kiosk-panel__title text-5xl font-extrabold tracking-tight text-gray-950">Printing...</h2>
              <p className="kiosk-panel__subtitle text-2xl text-gray-600 font-medium">Please wait while your document prints.</p>

              <div className="kiosk-progress w-full bg-gray-100 h-6 rounded-full mt-10 overflow-hidden shadow-inner">
                <div
        ...
        {status === 'completed' && (
          <div className="space-y-10 flex flex-col items-center animate-in fade-in zoom-in duration-500">
            <div className="kiosk-hero-icon kiosk-hero-icon--success w-40 h-40 bg-green-50 text-green-500 rounded-full flex items-center justify-center shadow-inner">
              <CheckCircle2 className="w-24 h-24" />
            </div>

            <div className="space-y-4">
              <h2 className="kiosk-panel__title text-5xl font-extrabold tracking-tight text-gray-950">Success!</h2>
              <p className="kiosk-panel__subtitle text-2xl text-gray-600 font-medium">Your document has been printed.<br />Please collect your pages.</p>
            </div>

            <Button size="xl" className="w-full mt-10 rounded-full px-16 h-20 text-2xl font-bold" onClick={() => navigate('/')}>
              Finish
            </Button>
          </div>
        )}
        ...
        {status === 'failed' && (
          <div className="space-y-10 flex flex-col items-center animate-in fade-in zoom-in duration-500">
            <div className="kiosk-hero-icon kiosk-hero-icon--danger w-40 h-40 bg-red-50 text-[#f03861] rounded-full flex items-center justify-center shadow-inner">
              <AlertCircle className="w-24 h-24" />
            </div>

            <div className="space-y-4">
              <h2 className="kiosk-panel__title text-5xl font-extrabold tracking-tight text-gray-950">Print Failed</h2>
              <p className="kiosk-panel__subtitle text-2xl text-gray-600 font-medium">There was an issue printing your document.<br />Please contact support.</p>
            </div>

            <Button size="xl" variant="outline" className="w-full mt-10 rounded-full px-16 h-20 text-2xl font-bold" onClick={() => navigate('/')}>
              Return Home
            </Button>
          </div>
        )}
