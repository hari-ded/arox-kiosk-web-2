...
export const Home = () => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-6 space-y-6 sm:space-y-12 relative z-10 w-full">
      <div className="text-center flex flex-col items-center space-y-4 max-w-4xl">
        <motion.div
      ...
      <motion.div
        ...
        className="grid w-full max-w-6xl grid-cols-1 lg:grid-cols-[1.12fr_0.88fr] gap-6 sm:gap-8 px-4"
      >
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35 }}>
          <Button
            size="xl"
            className="w-full h-full min-h-[340px] flex flex-col items-center justify-center gap-6 rounded-[2.75rem] border-0 bg-gradient-to-br from-[#fffaf3] via-white to-[#fff2e3] shadow-[0_18px_60px_rgba(240,56,97,0.12)] text-gray-900"
            onClick={() => navigate('/scan')}
          >
            <div className="p-5 sm:p-6 bg-[#fff2e3] rounded-full text-[#f5a623]">
              <ScanLine className="w-12 h-12 sm:w-16 sm:h-16" strokeWidth={2.5} />
            </div>
            <div className="space-y-2 text-center max-w-md">
              <div className="text-4xl sm:text-5xl font-bold tracking-tight">Scan QR Code</div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.42 }}>
          <Button
            variant="outline"
            size="xl"
            className="w-full h-full min-h-[320px] flex flex-col items-center justify-center gap-6 rounded-[2.75rem] border-2 border-gray-200 bg-white shadow-[0_12px_40px_rgba(17,24,39,0.06)] text-gray-900"
            onClick={() => navigate('/code')}
          >
            <div className="p-5 sm:p-6 bg-[#fff0f4] rounded-full text-[#f03861]">
              <KeyRound className="w-12 h-12 sm:w-16 sm:h-16" strokeWidth={2.5} />
            </div>
            <div className="space-y-2 text-center max-w-md">
              <div className="text-3xl sm:text-4xl font-bold tracking-tight">Enter Release Key</div>
